...
serpent_setkey (gcry_core_context_t c, void *ctx,
		const byte *key, unsigned int key_length)
{
  ...
  if (! serpent_init_done)
    {
      ...
      if (serpent_test_ret)
	log_error (c, "Serpent test failure: %s\n", serpent_test_ret);
      serpent_init_done = 1;
    }
...
static void
serpent_encrypt (gcry_core_context_t c,
		 void *ctx, byte *buffer_out, const byte *buffer_in)
{
  serpent_context_t *context = ctx;
...
static void
serpent_decrypt (gcry_core_context_t c,
		 void *ctx, byte *buffer_out, const byte *buffer_in)
{
  serpent_context_t *context = ctx;
...
static struct gcry_core_cipher_spec gcry_core_cipher_serpent128_struct =
  {
...
gcry_core_cipher_spec_t gcry_core_cipher_serpent128 = &gcry_core_cipher_serpent128_struct;

static struct gcry_core_cipher_spec gcry_core_cipher_serpent192_struct =
  {
...
gcry_core_cipher_spec_t gcry_core_cipher_serpent192 = &gcry_core_cipher_serpent192_struct;

static struct gcry_core_cipher_spec gcry_core_cipher_serpent256_struct =
  {
...
gcry_core_cipher_spec_t gcry_core_cipher_serpent256 = &gcry_core_cipher_serpent256_struct;
