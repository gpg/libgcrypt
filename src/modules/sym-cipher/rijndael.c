...
do_setkey (gcry_core_context_t c,
	   RIJNDAEL_context *ctx, const byte *key, const unsigned keylen)
{
...
static gcry_err_code_t
rijndael_setkey (gcry_core_context_t c, void *context, const byte *key, const unsigned keylen)
{
  RIJNDAEL_context *ctx = context;

  int rc = do_setkey (c, ctx, key, keylen);
...
static void
rijndael_encrypt (gcry_core_context_t c, void *context, byte *b, const byte *a)
{
  RIJNDAEL_context *ctx = context;
...
static void
rijndael_decrypt (gcry_core_context_t c, void *context, byte *b, const byte *a)
{
  RIJNDAEL_context *ctx = context;
...
selftest (gcry_core_context_t c)
{
  ...
  rijndael_setkey (c, &ctx, key, sizeof(key));
  rijndael_encrypt (c, &ctx, scratch, plaintext);
  if (memcmp (scratch, ciphertext, sizeof (ciphertext)))
    return "Rijndael-128 test encryption failed.";
  rijndael_decrypt (c, &ctx, scratch, scratch);
  if (memcmp (scratch, plaintext, sizeof (plaintext)))
    return "Rijndael-128 test decryption failed.";

  rijndael_setkey (c, &ctx, key_192, sizeof(key_192));
  rijndael_encrypt (c, &ctx, scratch, plaintext_192);
  ...
  rijndael_setkey (c, &ctx, key_256, sizeof(key_256));
  rijndael_encrypt (c, &ctx, scratch, plaintext_256);
...
static gcry_core_cipher_oid_spec_t rijndael_oids[] =
  {
...
static struct gcry_core_cipher_spec gcry_core_cipher_aes_struct =
  {
    "AES", rijndael_names, rijndael_oids, 16, 128, sizeof (RIJNDAEL_context),
    rijndael_setkey, rijndael_encrypt, rijndael_decrypt,
  };

gcry_core_cipher_spec_t gcry_core_cipher_aes = &gcry_core_cipher_aes_struct;
gcry_core_cipher_spec_t gcry_core_cipher_rijndael = &gcry_core_cipher_aes_struct;
...
static gcry_core_cipher_oid_spec_t rijndael192_oids[] =
  {
...
static struct gcry_core_cipher_spec gcry_core_cipher_aes192_struct =
  {
    "AES192", rijndael192_names, rijndael192_oids, 16, 192, sizeof (RIJNDAEL_context),
    rijndael_setkey, rijndael_encrypt, rijndael_decrypt,
  };

gcry_core_cipher_spec_t gcry_core_cipher_aes192 = &gcry_core_cipher_aes192_struct;
gcry_core_cipher_spec_t gcry_core_cipher_rijndael192 = &gcry_core_cipher_aes192_struct;
...
static gcry_core_cipher_oid_spec_t rijndael256_oids[] =
  {
...
static struct gcry_core_cipher_spec gcry_core_cipher_aes256_struct =
  {
...
gcry_core_cipher_spec_t gcry_core_cipher_aes256 = &gcry_core_cipher_aes256_struct;
gcry_core_cipher_spec_t gcry_core_cipher_rijndael256 = &gcry_core_cipher_aes256_struct;
