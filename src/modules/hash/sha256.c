...
static void
sha256_init (gcry_core_context_t ctx, void *context)
{
...
/* Update the message digest with the contents of INBUF with length
  INLEN.  */
static void
sha256_write (gcry_core_context_t ctx, void *context, byte *inbuf, size_t inlen)
{
  SHA256_CONTEXT *hd = context;
...
static void
sha256_final(gcry_core_context_t ctx, void *context)
{
  SHA256_CONTEXT *hd = context;
  u32 t, msb, lsb;
  byte *p;
  
  sha256_write (ctx, hd, NULL, 0); /* flush */;
...
static byte *
sha256_read (gcry_core_context_t ctx, void *context)
{
  SHA256_CONTEXT *hd = context;
...
static gcry_core_md_oid_spec_t oid_spec_sha256[] =
  {
...
static struct gcry_core_md_spec gcry_core_digest_sha256_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_sha256 = &gcry_core_digest_sha256_struct;
