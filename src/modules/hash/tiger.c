...
static void
tiger_init(gcry_core_context_t ctx, void *context )
{
 ...
 */
static void
tiger_write(gcry_core_context_t ctx, void *context, byte *inbuf, size_t inlen)
{
  TIGER_CONTEXT *hd = context;
 ...
 */
static void
tiger_final(gcry_core_context_t ctx, void *context )
{
  TIGER_CONTEXT *hd = context;
  u32 t, msb, lsb;
  byte *p;

  tiger_write(ctx, hd, NULL, 0); /* flush */;
...
static byte *
tiger_read(gcry_core_context_t ctx, void *context )
{
  TIGER_CONTEXT *hd = context;
...
static gcry_core_md_oid_spec_t oid_spec_tiger[] =
  {
...
static struct gcry_core_md_spec gcry_core_digest_tiger_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_tiger = &gcry_core_digest_tiger_struct;
