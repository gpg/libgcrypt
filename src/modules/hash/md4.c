...
static void
md4_init(gcry_core_context_t c, void *context )
{
 ...
 */
static void
md4_write(gcry_core_context_t ctx, void *context, byte *inbuf, size_t inlen)
{
...
static void
md4_final(gcry_core_context_t ctx, void *context )
{
  MD4_CONTEXT *hd = context;
  u32 t, msb, lsb;
  byte *p;

  md4_write(ctx, hd, NULL, 0); /* flush */;
...
static byte *
md4_read (gcry_core_context_t ctx, void *context)
{
  MD4_CONTEXT *hd = context;
  return hd->buf;
}
...
static gcry_core_md_oid_spec_t oid_spec_md4[] =
  {
...
static struct gcry_core_md_spec gcry_core_digest_md4_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_md4 = &gcry_core_digest_md4_struct;
