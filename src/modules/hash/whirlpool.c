...
static void
whirlpool_init (gcry_core_context_t c, void *ctx)
{
...
static void
whirlpool_write (gcry_core_context_t c,
		 void *ctx, unsigned char *buffer, size_t buffer_n)
{
  whirlpool_context_t *context = ctx;
...
static void
whirlpool_final (gcry_core_context_t c, void *ctx)
{
  whirlpool_context_t *context = ctx;
  unsigned int i;
...
static byte *
whirlpool_read (gcry_core_context_t c, void *ctx)
{
  whirlpool_context_t *context = ctx;
...
static struct gcry_core_md_spec gcry_core_digest_whirlpool_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_whirlpool = &gcry_core_digest_whirlpool_struct;
