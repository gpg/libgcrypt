...
static void
sha512_init (gcry_core_context_t ctx, void *context)
{
...
static void
sha384_init (gcry_core_context_t ctx, void *context)
{
  SHA512_CONTEXT *hd = context;
 ...
 */
static void
sha512_write (gcry_core_context_t ctx, void *context, byte *inbuf, size_t inlen)
{
  SHA512_CONTEXT *hd = context;
  ...
  if (hd->count)
	...
	hd->buf[hd->count++] = *inbuf++;
      sha512_write (ctx, context, NULL, 0);
      if (!inlen)
	return;
    }
...
static void
sha512_final (gcry_core_context_t ctx, void *context)
{
  SHA512_CONTEXT *hd = context;
  u64 t, msb, lsb;
  byte *p;

  sha512_write (ctx, context, NULL, 0); /* flush */ ;
...
static byte *
sha512_read (gcry_core_context_t ctx, void *context)
{
...
static gcry_core_md_oid_spec_t oid_spec_sha512[] =
  {
    { "2.16.840.1.101.3.4.2.3" },
    { NULL }
  };

static struct gcry_core_md_spec gcry_core_digest_sha512_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_sha512 = &gcry_core_digest_sha512_struct;
...
static gcry_core_md_oid_spec_t oid_spec_sha384[] =
  {
    { "2.16.840.1.101.3.4.2.2" }, 
    { NULL },
  };

static struct gcry_core_md_spec gcry_core_digest_sha384_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_sha384 = &gcry_core_digest_sha384_struct;
