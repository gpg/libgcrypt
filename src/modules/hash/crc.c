...
static void
crc32_init (gcry_core_context_t c, void *context)
{
...
static void
crc32_write (gcry_core_context_t c, void *context, byte * inbuf, size_t inlen)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
  if (!inbuf)
    return;
...
static byte *
crc32_read (gcry_core_context_t c, void *context)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
  return ctx->buf;
}
...
static void
crc32_final (gcry_core_context_t c, void *context)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
  ctx->CRC ^= 0xffffffffL;
...
/* CRC32 a'la RFC 1510 */
static void
crc32rfc1510_init (gcry_core_context_t c, void *context)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
  ctx->CRC = 0;
}
...
static void
crc32rfc1510_final (gcry_core_context_t c, void *context)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
  ctx->buf[0] = (ctx->CRC >> 24) & 0xFF;
  ctx->buf[1] = (ctx->CRC >> 16) & 0xFF;
...
static void
crc24rfc2440_init (gcry_core_context_t c, void *context)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
  ctx->CRC = CRC24_INIT;
}
...
static void
crc24rfc2440_write (gcry_core_context_t c,
		    void *context, byte * inbuf, size_t inlen)
{
  int i;
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
...
static void
crc24rfc2440_final (gcry_core_context_t c,void *context)
{
  CRC_CONTEXT *ctx = (CRC_CONTEXT *) context;
...
static struct gcry_core_md_spec gcry_core_digest_crc32_struct =
  {
    "CRC32", NULL, 0, NULL, 4,
...
gcry_core_md_spec_t gcry_core_digest_crc32 = &gcry_core_digest_crc32_struct;

static struct gcry_core_md_spec gcry_core_digest_crc32_rfc1510_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_crc32_rfc1510 =
&gcry_core_digest_crc32_rfc1510_struct;

static struct gcry_core_md_spec gcry_core_digest_crc24_rfc2440_struct =
  {
...
gcry_core_md_spec_t gcry_core_digest_crc24_rfc2440 =
&gcry_core_digest_crc24_rfc2440_struct;
