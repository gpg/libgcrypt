...
#define GCRYPT_VERSION "2.0.0-cvs2"
...
typedef gcry_core_handler_log_t gcry_handler_log_t;
typedef gcry_core_handler_progress_t gcry_handler_progress_t;
typedef gcry_core_handler_alloc_t gcry_handler_alloc_t;
typedef gcry_core_handler_realloc_t gcry_handler_realloc_t;
typedef gcry_core_handler_free_t gcry_handler_free_t;
typedef gcry_core_handler_no_mem_t gcry_handler_no_mem_t;
typedef gcry_core_handler_error_t gcry_handler_error_t;

/* We need to define this type ourselves, since libgcrypt-core does
   not use such a "secure_check" handler, instead such a function is
   part of the secmem subsystem interface.  */
typedef int (*gcry_handler_secure_check_t) (const void *);

typedef gcry_core_sexp_t gcry_sexp_t;
typedef gcry_core_mpi_t gcry_mpi_t;

typedef gcry_core_ac_key_type_t gcry_ac_key_type_t;
typedef gcry_core_ac_em_t gcry_ac_em_t;
typedef gcry_core_ac_scheme_t gcry_ac_scheme_t;
typedef struct gcry_ac_data *gcry_ac_data_t;
typedef gcry_core_ac_key_t gcry_ac_key_t;
typedef gcry_core_ac_key_pair_t gcry_ac_key_pair_t;
typedef gcry_core_ac_data_read_cb_t gcry_ac_data_read_cb_t;
typedef gcry_core_ac_data_write_cb_t gcry_ac_data_write_cb_t;
typedef gcry_core_ac_io_mode_t gcry_ac_io_mode_t;
typedef gcry_core_ac_io_type_t gcry_ac_io_type_t;
typedef gcry_core_ac_io_t gcry_ac_io_t;
typedef gcry_core_ac_eme_pkcs_v1_5_t gcry_ac_eme_pkcs_v1_5_t;
...
enum gcry_ctl_cmds 
  {
    ...
    GCRYCTL_DISABLE_AUTO_PRNG_POOL_FILLING = 49,
  };
...
void gcry_md_putc_do (gcry_md_hd_t hd, unsigned char c);

/* Update the hash(s) of H with the character C.  This is a buffered
   version of the gcry_md_write function. */
#define gcry_md_putc(h,c) gcry_md_putc_do (h, c)
...
#define GCRY_AC_KEY_SECRET GCRY_CORE_AC_KEY_SECRET
#define GCRY_AC_KEY_PUBLIC GCRY_CORE_AC_KEY_PUBLIC

#define GCRY_AC_EME_PKCS_V1_5  GCRY_CORE_AC_EME_PKCS_V1_5
#define GCRY_AC_EMSA_PKCS_V1_5 GCRY_CORE_AC_EMSA_PKCS_V1_5

#define GCRY_AC_ES_PKCS_V1_5  GCRY_CORE_AC_ES_PKCS_V1_5
#define GCRY_AC_SSA_PKCS_V1_5 GCRY_CORE_AC_SSA_PKCS_V1_5

#define GCRY_AC_IO_READABLE GCRY_CORE_AC_IO_READABLE
#define GCRY_AC_IO_WRITABLE GCRY_CORE_AC_IO_WRITABLE
#define GCRY_AC_IO_STRING   GCRY_CORE_AC_IO_STRING
#define GCRY_AC_IO_CALLBACK GCRY_CORE_AC_IO_CALLBACK
...
#define GCRY_AC_FLAG_NO_BLINDING GCRY_CORE_AC_FLAG_NO_BLINDING
...
void gcry_set_progress_handler (gcry_core_handler_progress_t cb, void *cb_data);
...
/* Register a function used instead of the internal out of memory
   handler. */
void gcry_set_outofcore_handler (gcry_core_handler_no_mem_t h, void *opaque);

/* Register a function used instead of the internal fatal error
   handler. */
void gcry_set_fatalerror_handler (gcry_core_handler_error_t fnc, void *opaque);

/* Register a function used instead of the internal logging
   facility. */
void gcry_set_log_handler (gcry_core_handler_log_t f, void *opaque);
