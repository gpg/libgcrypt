/* gcrypt-module.h - Libgcrypt module interface
...
typedef gcry_core_cipher_oid_spec_t gcry_cipher_oid_spec_t;
...
typedef gcry_pk_spec_t gcry_ac_spec_t;
...
/* Register a new pubkey module whose specification can be found in
   PUBKEY.  On success, a new algorithm ID is stored in ALGORITHM_ID
   and a pointer representhing this module is stored in MODULE.  */
gcry_error_t gcry_ac_register (gcry_ac_spec_t *pubkey,
			       unsigned int *algorithm_id,
			       gcry_module_t *module);
...
typedef gcry_core_md_oid_spec_t gcry_md_oid_spec_t;
