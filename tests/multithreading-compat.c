/* multithreading-compat.c - Test multithreading support
...
//#ifdef HAVE_PTHREAD
void
create_thread_pthread (void *(*func) (void *arg), void *arg)
{
  pthread_t thread_id;
  int ret;
...
//#ifdef HAVE_PTH
void
create_thread_pth (void *(*func) (void *arg), void *arg)
{
  pth_attr_t attr;
  pth_t thread_id;
...
void (*create_thread) (void *(*func) (void *arg), void *arg) = create_thread_pthread;
